...
TOKEN = '6798824631:AAElKTCaRW9P50_B84LCpmNCuuCaIglnPCY'
bot = telebot.TeleBot(TOKEN, threaded=False)

# 🛡️ List of authorized user IDs (replace with actual IDs)
AUTHORIZED_USERS = [6053806887,1975900042,1002248712522]
...
def start(message):
    ...
    if user_id not in AUTHORIZED_USERS:
        bot.send_message(message.chat.id, "🚫 Access Denied! Contact the owner for assistance: @psycho2465")
    else:
        welcome_message = (
            ...
            "📞 Contact the owner on Instagram and Telegram: @psycho2465\n"
...
def owner(message):
    ...
    bot.send_message(message.chat.id, "📞 Contact the owner: @psycho2465")
...
This bot is owned and operated by @psycho2465 on Telegram and all4outgaming on Instagram, 🇮🇳. By using this bot, you acknowledge that you understand and agree to the following terms:
...
if __name__ == "__main__":
    ...
    print(" 👍 Bot is now online with @psycho2465 Script and ready to Ddos_attack! ▰▱▰▱▰▱▰▱▰▱▰▱▰▱")
